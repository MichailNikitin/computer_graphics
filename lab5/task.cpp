...
void chaikin() {
   ...
   {
      x = pow((1-t),3)*points[0].x+3*t*pow((1-t),2)*points[1].x+3*t*t*(1-t)*points[2].x+pow(t,3)*points[3].x;
      y = pow((1-t),3)*points[0].y+3*t*pow((1-t),2)*points[1].y+3*t*t*(1-t)*points[2].y+pow(t,3)*points[3].y;
